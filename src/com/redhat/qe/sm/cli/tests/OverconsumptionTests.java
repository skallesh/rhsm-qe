...
public class OverconsumptionTests extends SubscriptionManagerCLITestScript{
	...
	public void BasicAttemptToOversubscribe_Test() throws JSONException, Exception {
		...
		client1tasks.register(clientusername, clientpassword, null, null, registereeName, null, null, Boolean.TRUE, null, null, null);
		...
		for (int i=quantity; i>0; i--) {
			...
			systemConsumerIds.add(client1tasks.getCurrentConsumerId(client1tasks.register(clientusername, clientpassword, null, null, registereeName, null, null, null, null, null, null)));
...
//		Assert.assertNotNull(pool, "Found the test pool amongst --all --available after having consumed all of its available entitlements.");
	...
	public void ConcurrentAttemptToSubscribe_Test() throws JSONException, Exception {
		...
		client1tasks.clean(null,null,null);
		client1tasks.register(clientusername,clientpassword,null,null,registereeName,systemConsumerIds.get(0), null, null, null, null, null);
		...
		client2tasks.register(clientusername,clientpassword,null,null,registereeName,systemConsumerIds.get(1), null, null, null, null, null);
...
//		Assert.assertEquals(pool.quantity, "0", "Asserting the test pool quantity has dropped by 2 due to the concurrent call to subscribe.");
	...
	public void ConcurrentAttemptToOversubscribe_Test() throws JSONException, Exception {
		...
		client2tasks.clean(null,null,null);
		systemConsumerIds.add(client2tasks.getCurrentConsumerId(client2tasks.register(clientusername, clientpassword, null, null, registereeName, null, null, null, null, null, null)));
	...
	public void unsubscribeAndUnregisterMultipleSystemsAfterClass() {
		...
		if (client1tasks!=null) {
			...
			for (String systemConsumerId : systemConsumerIds) {
				client1tasks.register_(clientusername,clientpassword,null,null,null,systemConsumerId, null, Boolean.TRUE, null, null, null);
