...
//if (!pool.quantity.equalsIgnoreCase("unlimited")) throw new SkipException("debugging...");
	...
	public void MultiClientRegisterAsPerson_Test() throws JSONException, Exception {
		...
		SSHCommandResult sshCommandResult = client2tasks.register_(username, password, owner, null, ConsumerType.person, null, null, null, (String)null, null, null, null, null, null);
