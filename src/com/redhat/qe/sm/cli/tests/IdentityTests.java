...
public class IdentityTests extends SubscriptionManagerCLITestScript {
	...
	public void IdentityWithName_Test() {
		...
		String consumerId = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientusername,sm_clientpassword,sm_clientowner,null,nickname,null, null, null, null, null, null));
	...
	public void IdentityRegenerate_Test() {
		...
		// start fresh by unregistering and registering
		clienttasks.unregister(null, null, null);
		SSHCommandResult registerResult = clienttasks.register(sm_clientusername,sm_clientpassword,sm_clientowner,null,null,null, null, null, null, null, null);
	...
	public void IdentityRegenerateWithUsernameAndPaswordFromTheSameOwner_Test() throws Exception {
		...
		// start fresh by unregistering and registering
		clienttasks.unregister(null, null, null);
		SSHCommandResult registerResult = clienttasks.register(sm_clientusername,sm_clientpassword,sm_clientusername,null,null,null, null, null, null, null, null);
