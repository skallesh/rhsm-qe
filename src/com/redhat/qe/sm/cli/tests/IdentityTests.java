...
public class IdentityTests extends SubscriptionManagerCLITestScript {
	...
	public void IdentityWithName_Test() {
		...
		String consumerId = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,nickname,null, null, nullString, null, null, null, null));
	...
	public void IdentityRegenerate_Test() {
		...
		// start fresh by unregistering and registering
		clienttasks.unregister(null, null, null);
		SSHCommandResult registerResult = clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null, null, nullString, null, null, null, null);
