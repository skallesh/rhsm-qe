...
public class IdentityTests extends SubscriptionManagerCLITestScript {
	...
	public void IdentityWithName_Test() {
		...
		String consumerId = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,nickname, null, null, null, null, null, null));
