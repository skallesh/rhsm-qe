...
public class RefreshTests extends SubscriptionManagerCLITestScript {
	...
	public void RefreshEntitlements_Test() {
		...
		clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername,sm_clientPassword,sm_clientOrg,null,null,null,null, null, null, null, null, null, null));
