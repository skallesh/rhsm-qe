...
public class CleanTests extends SubscriptionManagerCLITestScript {
	...
	public void Clean_Test() {
		...
		consumerId = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientusername,sm_clientpassword,sm_clientowner,null,null,null, null, null, null, null, null));
	...
	public void teardownAfterClass() {
		if (consumerId!=null) {
			clienttasks.clean(null, null, null);
			clienttasks.register(sm_clientusername, sm_clientpassword, null, null, null, consumerId, null, Boolean.TRUE, null, null, null);
			clienttasks.unregister(null, null, null);
		}
