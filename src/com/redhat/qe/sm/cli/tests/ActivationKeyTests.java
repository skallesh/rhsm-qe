...
//		int addQuantity = Math.max(1,randomGenerator.nextInt(quantityAvail+1));	// avoid a addQuantity < 1 see https://bugzilla.redhat.com/show_bug.cgi?id=729125
		...
		SSHCommandResult registerResult = clienttasks.register_(null, null, sm_clientOrg, null, null, null, null, null, null, null, jsonActivationKey.getString("name"), true, null, null, null, null);
		...
		if (!CandlepinTasks.isPoolProductConsumableByConsumerType(sm_clientUsername, sm_clientPassword, sm_serverUrl, poolId, ConsumerType.system)) {
			...
			registerResult = clienttasks.register_(null, null, sm_clientOrg, null, type, null, null, null, null, null, jsonActivationKey.getString("name"), false /*was already unregistered by force above*/, null, null, null, null);
		}
	...
	public void RegisterWithActivationKeyUsingWrongOrg_Test() throws JSONException, Exception {
		...
		for (String org : orgs) {
			...
			for (String differentOrg : orgs) {
				...
				SSHCommandResult registerResult = clienttasks.register_(null,null,differentOrg,null,null,null,null,null,null,null,activationKeyName,true,null, null, null, null);
	...
	public void RegisterWithActivationKeyContainingPoolForWhichNotEnoughQuantityRemains_Test(Object blockedByBug, String keyName, JSONObject jsonPool) throws JSONException, Exception {
		...
		String consumer1Id = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, consumerType, null, null, null, null, null, (String)null, true, null, null, null, null));
...
//			addedPoolIds.add(poolId);
		...
		// register with the activation key
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, jsonActivationKey.getString("name"), true, null, null, null, null);
	...
	public void RegisterWithListOfCommaSeparatedActivationKeys_Test() throws JSONException, Exception {
		...
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, commaSeparatedActivationKeyNames, true, null, null, null, null);
	...
	public void RegisterWithSequenceOfMultipleActivationKeys_Test() throws JSONException, Exception {
		...
		// register with the activation key specified as a single string
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, activationKeyNames, true, null, null, null, null);
	...
	public void unregisterAllSystemConsumerIds() {
		if (clienttasks!=null) {
			for (String systemConsumerId : systemConsumerIds) {
				clienttasks.register_(sm_clientUsername,sm_clientPassword,null,null,null,null,systemConsumerId, null, null, null, (String)null, Boolean.TRUE, null, null, null, null);
