...
//		sm.subscribeToEachOfTheCurrentlyAvailableSubscriptionPools();
	...
	public void SubscribeConsumerToEachAvailableSubscriptionPoolUsingPoolId_Test(String username, String password, String owner){
		clienttasks.unregister(null, null, null);
		clienttasks.register(username, password, owner, ConsumerType.system, null, null, Boolean.FALSE, null, Boolean.FALSE, null, null, null);
	...
	public void rhsmcertdChangeCertFrequency_Test(int minutes) {
	    ...
	    clienttasks.register(sm_clientUsername, sm_clientPassword, null, null, null, consumerid, null, null, Boolean.TRUE, null, null, null);
		clienttasks.restart_rhsmcertd(minutes, false); sleep(10000); // allow 10sec for the initial update
		log.info("Appending a marker in the '"+clienttasks.rhsmcertdLogFile+"' so we can assert that the certificates are being updated every '"+minutes+"' minutes");
...
//	List<SubscriptionPool> availableSubscriptionPoolsBeforeAutosubscribe;
	...
	public void MultiConsumerSubscribeWithQuantity_Test() throws NumberFormatException, JSONException, Exception {
		...
		clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, "SubscriptionQuantityConsumer2", null, null, null, false, null, null, null);
		...
		clienttasks.clean(null,null,null);
		clienttasks.register(sm_clientUsername, sm_clientPassword, null, null, null, consumer1Id, null, null, false, null, null, null);
		...
		clienttasks.register(sm_clientUsername, sm_clientPassword, null, null, null, consumer2Id, null, null, true, null, null, null);
	...
	public void unregisterAllSystemConsumerIds() {
		if (clienttasks!=null) {
			for (String systemConsumerId : systemConsumerIds) {
				clienttasks.register_(sm_clientUsername,sm_clientPassword,null,null,null,systemConsumerId, null, null, Boolean.TRUE, null, null, null);
	...
	protected List<List<Object>>getSubscribeWithQuantityDataAsListOfLists() throws JSONException, Exception {
		...
		// register
		clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, "SubscriptionQuantityConsumer", null, null, null, true, null, null, null);
