...
/**
 * This class was copied and modified from com.redhat.qe.jul.ConsoleLogFormatter
 */
public class ConsoleLogFormatterForRHSM extends Formatter {
...
//		return date + " - " + record.getLevel() + ": " + message + " (" + record.getSourceClassName() + "." + record.getSourceMethodName() + ")\n" + throwable;
		
		return date + "  " + record.getLevel() + ": " + message + "\n" + throwable;
	}
