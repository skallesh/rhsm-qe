  ...
  :start (merge
    ...
    (define-elements (windows :firstboot-window)
      {:firstboot-back "Back"
       ...
       ;;:register-now "rbtnYes,I'dliketoregisternow"
       ...
       :firstboot-server-entry "satellite server location"
       ...
       :firstboot-organization-selection "scpnorgselectionscrolledwindow"
       :firstboot-owner-table "tbl0"})
    (define-elements (windows :firstboot-proxy-dialog)
      {;;:firstboot-proxy-checkbox "Proxy Checkbox"
       :firstboot-proxy-checkbox "I would like to connect to RedHat Network via an HTTP proxy"
