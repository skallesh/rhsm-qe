...
//if (!jsonPool.getString("productId").equals("awesomeos-virt-unlimited")) throw new SkipException("debugging...");
		...
		SSHCommandResult registerResult = clienttasks.register_(null, null, sm_clientOrg, null, null, null, null, null, null, null, jsonActivationKey.getString("name"), null, null, true, null, null, null, null);
		...
		if (!CandlepinTasks.isPoolProductConsumableByConsumerType(sm_clientUsername, sm_clientPassword, sm_serverUrl, poolId, ConsumerType.system)) {
			...
			registerResult = clienttasks.register_(null, null, sm_clientOrg, null, type, null, null, null, null, null, jsonActivationKey.getString("name"), null, null, false /*was already unregistered by force above*/, null, null, null, null);
		}
	...
	public void RegisterWithActivationKeyUsingWrongOrg_Test() throws JSONException, Exception {
		...
		for (String org : orgs) {
			...
			for (String differentOrg : orgs) {
				...
				SSHCommandResult registerResult = clienttasks.register_(null,null,differentOrg,null,null,null,null,null,null,null,activationKeyName,null,null, true, null, null, null, null);
	...
	public void RegisterWithActivationKeyContainingPoolForWhichNotEnoughQuantityRemains_Test(Object blockedByBug, String keyName, JSONObject jsonPool) throws JSONException, Exception {
		...
		String consumer1Id = clienttasks.getCurrentConsumerId(clienttasks.register(sm_clientUsername, sm_clientPassword, sm_clientOrg, null, consumerType, null, null, null, null, null, (String)null, null, null, true, null, null, null, null));
...
//			addedPoolIds.add(poolId);
		...
		// register with the activation key
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, jsonActivationKey.getString("name"), null, null, true, null, null, null, null);
	...
	@Test(	description="create many activation keys with one added pool per key and then register with --activationkey=comma_separated_string_of_keys asserting all the pools get consumed",
			groups={/*"blockedByBug-844455"*/"blockedByBug-878986"},
			enabled=true)
	//@ImplementsNitrateTest(caseId=)	
	public void RegisterWithListOfCommaSeparatedActivationKeys_Test() throws JSONException, Exception {
		...
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, commaSeparatedActivationKeyNames, null, null, true, null, null, null, null);
	...
	public void RegisterWithSequenceOfMultipleActivationKeys_Test() throws JSONException, Exception {
		...
		// register with the activation key specified as a single string
		SSHCommandResult registerResult = clienttasks.register(null, null, sm_clientOrg, null, null, null, null, null, null, null, activationKeyNames, null, null, true, null, null, null, null);
