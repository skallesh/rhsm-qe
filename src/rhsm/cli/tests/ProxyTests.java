...
//					role= DefTypes.Role.VERIFIES),
	...
	protected List<List<Object>> getRegisterAttemptsUsingProxyServerDataAsListOfLists() {
		...
		if (clienttasks.isPackageVersion("subscription-manager",">=","1.18.2-1")) {	// post commit ad982c13e79917e082f336255ecc42615e1e7707	1176219: Error out if bad proxy settings detected
			...
			if (/*TODO FIGURE OUT WHY STDERR IS pErrMsg ON RHEL76 AND rErrMsg ON RHEL75; temporarily forcing with false*/ false && clienttasks.isPackageVersion("python-rhsm",">=","1.18.5-1") && Integer.valueOf(clienttasks.redhatReleaseX)>=7) {	// post commit 214103dcffce29e31858ffee414d79c1b8063970	Reduce usage of m2crypto https://github.com/candlepin/python-rhsm/pull/184
