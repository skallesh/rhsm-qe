...
public class ProxyTests extends SubscriptionManagerCLITestScript {
	...
	public void testListAttemptsUsingProxyServer(Object blockedByBug, String username, String password, String org, String proxy, String proxyuser, String proxypassword, Integer exitCode, String stdout, String stderr) {
		...
		SSHCommandResult attemptResult = clienttasks.list_(null,Boolean.TRUE,null,null,null, null, null, null, null, null, null, proxy, proxyuser, proxypassword, null);
		if (exitCode!=null)	Assert.assertEquals(attemptResult.getExitCode(), exitCode, "The exit code from an attempt to "+moduleTask+" using a proxy server.");
		if (stdout!=null)	Assert.assertEquals(attemptResult.getStdout().trim(), stdout, "The stdout from an attempt to "+moduleTask+" using a proxy server.");
		if (stderr!=null)	Assert.assertEquals(attemptResult.getStderr().trim(), stderr, "The stderr from an attempt to "+moduleTask+" using a proxy server.");
	}
	...
	@TestDefinition(//update=true,	// uncomment to make TestDefinition changes update Polarion testcases through the polarize testcase importer
			...
			tags= "Tier3")
	@Test(	description="subscription-manager : release using a proxy server after setting rhsm.config parameters (Positive and Negative Variations)",
			groups={"Tier3Tests","blockedByBug-822965","blockedByBug-824530","blockedByBug-1570558"},
			dataProvider="getReleaseAttemptsUsingProxyServerViaRhsmConfigData",
			enabled=true)
	//@ImplementsNitrateTest(caseId=)	
	...
	@Test(	description="subscription-manager : repos using a proxy server after setting rhsm.config parameters (Positive and Negative Variations)",
			groups={"Tier3Tests","blockedByBug-906642","blockedByBug-909778","blockedByBug-1570558"},
...
//					role= DefTypes.Role.VERIFIES),
	...
	protected List<List<Object>> getRegisterAttemptsUsingProxyServerDataAsListOfLists() {
		...
		if (clienttasks.isPackageVersion("subscription-manager",">=","1.18.2-1")) {	// post commit ad982c13e79917e082f336255ecc42615e1e7707	1176219: Error out if bad proxy settings detected
			...
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","838242"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(0),		null,		null}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","1176219"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	"bad-proxy",			sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(69),	null,		pErrMsg}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1119688","1301215"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl+"0",	sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(69),	null,		pErrMsg}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","1176219"));
			if (Integer.valueOf(clienttasks.redhatReleaseX)>=7) bugIds.add("1560727");	// Bug 1560727 - Uncaught proxy authentication failure (407) on RHEL7
			if (Integer.valueOf(clienttasks.redhatReleaseX)>=8) bugIds.add("1599801");	// Bug 1599801 - negative proxy tests on RHEL8 encounter OSError tracebacks in rhsm.log
			if (/*WHY IS STDERR pErrMsg ON RHEL76 AND rErrMsg ON RHEL75? - due to Bug 1560727; permanently forcing to false*/ false && clienttasks.isPackageVersion("python-rhsm",">=","1.18.5-1") && Integer.valueOf(clienttasks.redhatReleaseX)>=7) {	// post commit 214103dcffce29e31858ffee414d79c1b8063970	Reduce usage of m2crypto https://github.com/candlepin/python-rhsm/pull/184
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		"bad-username",					sm_basicauthproxyPassword,	Integer.valueOf(69),	null,		rErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		sm_basicauthproxyUsername,		"bad-password",				Integer.valueOf(69),	null,		rErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		"bad-username",					"bad-password",				Integer.valueOf(69),	null,		rErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		null,							null,						Integer.valueOf(69),	null,		rErrMsg}));
			} else {
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		"bad-username",					sm_basicauthproxyPassword,	Integer.valueOf(69),	null,		pErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		sm_basicauthproxyUsername,		"bad-password",				Integer.valueOf(69),	null,		pErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		"bad-username",					"bad-password",				Integer.valueOf(69),	null,		pErrMsg}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		null,							null,						Integer.valueOf(69),	null,		pErrMsg}));
			}
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","838242","1354667"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			"bad-username",		sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,		sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(70),	null,		uErrMsg}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	"bad-password",		sm_clientOrg,	basicauthproxyUrl,		sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(70),	null,		uErrMsg}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","838242"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	"bad-org",		basicauthproxyUrl,		sm_basicauthproxyUsername,		sm_basicauthproxyPassword,	Integer.valueOf(70),	null,		oErrMsg}));
			
			// no auth proxy test data...
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	noauthproxyUrl,			null,							null,						Integer.valueOf(0),		null,		null}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	noauthproxyUrl,			"ignored-username",				"ignored-password",			Integer.valueOf(0),		null,		null}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1119688","1301215"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	noauthproxyUrl+"0",		null,							null,						Integer.valueOf(69),	null,		pErrMsg}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","1354667"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			"bad-username",		sm_clientPassword,	sm_clientOrg,	noauthproxyUrl,			null,							null,						Integer.valueOf(70),	null,		uErrMsg}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	"bad-password",		sm_clientOrg,	noauthproxyUrl,			null,							null,						Integer.valueOf(70),	null,		uErrMsg}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),			sm_clientUsername,	sm_clientPassword,	"bad-org",		noauthproxyUrl,			null,							null,						Integer.valueOf(70),	null,		oErrMsg}));
...
//		String port = clienttasks.getConfParameter("port");
		...
		if (clienttasks.isPackageVersion("subscription-manager",">=","1.18.2-1")) {	// post commit ad982c13e79917e082f336255ecc42615e1e7707	1176219: Error out if bad proxy settings detected
			...
			// basic auth proxy test data...
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(0),		null,	null,		basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			if(clienttasks.isPackageVersion("subscription-manager",">=","1.20.1-1")) {	// commit c26af03e547209f216d29d02867d73843e1e5535	// Bug 1392709: Display better error msg., when wrong proxy is set up
				bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","1392709"));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						"bad-proxy",				sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	pErrConMsg,	basicauthproxy,	sm_basicauthproxyLog,	null}));
			} else {
				bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688"));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						"bad-proxy",				sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	nErrMsg,	basicauthproxy,	sm_basicauthproxyLog,	null}));
			}
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort+"0",	sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	nErrMsg,	basicauthproxy,	sm_basicauthproxyLog,	null}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","1176219"));
			if (Integer.valueOf(clienttasks.redhatReleaseX)>=7) bugIds.add("1560727");	// Bug 1560727 - Uncaught proxy authentication failure (407) on RHEL7
			if (Integer.valueOf(clienttasks.redhatReleaseX)>=8) bugIds.add("1599801");	// Bug 1599801 - negative proxy tests on RHEL8 encounter OSError tracebacks in rhsm.log
			if (clienttasks.isPackageVersion("python-rhsm",">=","1.18.5-1")) {	// post commit 214103dcffce29e31858ffee414d79c1b8063970	Reduce usage of m2crypto https://github.com/candlepin/python-rhsm/pull/184
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		"bad-username",				sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	pErrConMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	"bad-password",				Integer.valueOf(70),	null,	pErrConMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		"bad-username",				"bad-password",				Integer.valueOf(70),	null,	pErrConMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		""/*no username*/,			""/*no password*/,			Integer.valueOf(70),	null,	pErrConMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
			} else {
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		"bad-username",				sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	pErr407Msg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	"bad-password",				Integer.valueOf(70),	null,	pErr407Msg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		"bad-username",				"bad-password",				Integer.valueOf(70),	null,	pErr407Msg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		""/*no username*/,			""/*no password*/,			Integer.valueOf(70),	null,	pErr407Msg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_DENIED"}));	
			}
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,	null,						null,						"bad-proxy",				sm_basicauthproxyPort+"0",	sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(0),		null,	null,		basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,	sm_basicauthproxyUsername,	null,						"bad-proxy",				sm_basicauthproxyPort+"0",	"bad-username",				sm_basicauthproxyPassword,	Integer.valueOf(0),		null,	null,		basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","838242"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	basicauthproxyUrl,	sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	"bad-proxy",				sm_basicauthproxyPort+"0",	"bad-username",				"bad-password",				Integer.valueOf(0),		null,	null,		basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(0),		null,	null,		basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","1354667"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		"bad-username",		sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	uErrMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	"bad-password",		sm_clientOrg,	null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	uErrMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	"bad-org",		null,				null,						null,						sm_basicauthproxyHostname,	sm_basicauthproxyPort,		sm_basicauthproxyUsername,	sm_basicauthproxyPassword,	Integer.valueOf(70),	null,	oErrMsg,	basicauthproxy,	sm_basicauthproxyLog,	"TCP_MISS"}));
			
			// no auth proxy test data...
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"",							"",							Integer.valueOf(0),		null,	null,		noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"ignored-username",			"ignored-password",			Integer.valueOf(0),		null,	null,		noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort+"0",		"",							"",							Integer.valueOf(70),	null,	nErrMsg,	noauthproxy,	sm_noauthproxyLog,		null}));
			if (clienttasks.isPackageVersion("subscription-manager",">=","1.20.1-1")) {	// commit c26af03e547209f216d29d02867d73843e1e5535	// Bug 1392709: Display better error msg., when wrong proxy is set up
				bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","1392709"));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						"bad-proxy",				sm_noauthproxyPort,			"",							"",							Integer.valueOf(70),	null,	pErrConMsg,	noauthproxy,	sm_noauthproxyLog,		null}));
			} else {
				bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688"));
				ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),	sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	null,				null,						null,						"bad-proxy",				sm_noauthproxyPort,			"",							"",							Integer.valueOf(70),	null,	nErrMsg,	noauthproxy,	sm_noauthproxyLog,		null}));
			}
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258","1354667"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		"bad-username",		sm_clientPassword,	sm_clientOrg,	null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"",							"",							Integer.valueOf(70),	null,	uErrMsg,	noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	"bad-password",		sm_clientOrg,	null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"",							"",							Integer.valueOf(70),	null,	uErrMsg,	noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","755258"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	"bad-org",		null,				null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"",							"",							Integer.valueOf(70),	null,	oErrMsg,	noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	noauthproxyUrl,		null,						null,						"bad-proxy",				sm_noauthproxyPort+"0",		"",							"",							Integer.valueOf(0),		null,	null,		noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	noauthproxyUrl,		"ignored-username",			"ignored-password",			"bad-proxy",				sm_noauthproxyPort+"0",		"bad-username",				"bad-password",				Integer.valueOf(0),		null,	null,		noauthproxy,	sm_noauthproxyLog,		"Connect"}));
			bugIds.clear(); bugIds.addAll(Arrays.asList("1345962","1119688","1176219","1403387"));
			ll.add(Arrays.asList(new Object[]{	new BlockedByBzBug(bugIds.toArray(new String[]{})),		sm_clientUsername,	sm_clientPassword,	sm_clientOrg,	"bad-proxy",		null,						null,						sm_noauthproxyHostname,		sm_noauthproxyPort,			"",							"",							Integer.valueOf(69),	null,	pErrMsg/*DELETEME - THIS WAS A BUG 1403387 "Unable to reach the server at "+hostname+":"+port+prefix*/,	noauthproxy,	sm_noauthproxyLog,		null}));
			...
			if (CandlepinType.standalone.equals(sm_serverType)) {
				if (SubscriptionManagerTasks.isVersion(servertasks.statusVersion, ">=", "2.0.7-1")) {	// candlepin commit 676ce6c2786203a33ec5eedc8dadcd664a62f09e 1263474: Standalone candlepin now returns the expected error message and code
					if (((Integer)l.get(7)).equals(Integer.valueOf(0))) {	// exit code
						...
						bugIds.add("1345962");	// Bug 1345962 - unbound method endheaders() must be called with HTTPSConnection instance as first argument (got RhsmProxyHTTPSConnection instance instead)
						blockedByBzBug = new BlockedByBzBug(bugIds.toArray(new String[]{}));
						String errorMsg="Standalone candlepin does not support redeeming a subscription.";
						if (clienttasks.isPackageVersion("subscription-manager",">=","1.21.2-1")) {	// post commit 630e1a2eb06e6bfacac669ce11f38e228c907ea9 1507030: RestlibExceptions should show they originate server-side
							errorMsg = "HTTP error code 503: "+errorMsg;	// HTTP error (401 - Unauthorized): Invalid Credentials
						}
						ll.add(Arrays.asList(new Object[]{	blockedByBzBug,	l.get(1),	l.get(2),	l.get(3),	l.get(4),	l.get(5),	l.get(6),	new Integer(70)/*EX_SOFTWARE*/,	l.get(8),	new String(errorMsg)}));
						continue;
					}
				}
			}
