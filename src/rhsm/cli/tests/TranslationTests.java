...
// debugTesting pofilterTests = Arrays.asList("newlines");
	...
	protected List<List<Object>> getTranslatedCommandLineHelpDataAsListOfLists() {
		...
		lang = "zh_TW"; output = "使用方法：subscription-manager 模塊 -名稱  [模塊 -選項] [--help]";								helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		lang = "or_IN"; output = "ବ୍ୟବହାର ବିଧ: subscription-manager ମଡ୍ୟୁଲଗୁଡ଼ିକ-ନାମ [ମଡ୍ୟୁଲଗୁଡ଼ିକ-ବିକଳ୍ପଗୁଡିକ] [--help]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		lang = "te_IN"; output = "వాడుక: subscription-manager మాడ్యూళ్ళు-పేరు [మాడ్యూళ్ళు-ఐచ్చికములు] [--help]";						helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		command = clienttasks.command + " clean";
		lang = "en_US"; output = "Options:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "de_DE"; output = "Optionen:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "es_ES"; output = "Opciones:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "fr_FR"; output = "Options:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "it_IT"; output = "Opzioni:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ja_JP"; output = "オプション:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ko_KR"; output = "옵션:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pt_BR"; output = "Opções:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ru_RU"; output = "Параметры:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_CN"; output = "选项:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_TW"; output = "選項:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "as_IN"; output = "বিকল্পসমূহ:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "bn_IN"; output = "বিকল্প:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "hi_IN"; output = "विकल्प:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "mr_IN"; output = "पर्याय:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "gu_IN"; output = "વિકલ્પો:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "kn_IN"; output = "ಆಯ್ಕೆಗಳು:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ml_IN"; output = "ഐച്ഛികങ്ങള്‍:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "or_IN"; output = "ବିକଳ୍ପଗୁଡିକ:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pa_IN"; output = "ਚੋਣਾਂ:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ta_IN"; output = "விருப்பங்கள் :";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "te_IN"; output = "ఐచ్చికములు:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		lang = "bn_IN"; output = "ব্যবহারপ্রণালী: rhn-migrate-classic-to-rhsm [বিকল্]";							helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", /*"\\\\[($1|OPTIONS)\\\\]"*/"\\\\[$1\\\\]")+"$")}));
		...
		lang = "en_US"; output = "show this help message and exit";						helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "de_DE"; output = "Zeige diese Hilfenachricht und beende:";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "es_ES"; output = "mostrar este mensaje de ayuda y salir";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "fr_FR"; output = "afficher ce message d'aide et quitter";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "it_IT"; output = "mostra questo messaggio d'aiuto ed esci";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ja_JP"; output = "このヘルプメッセージを表示して終了";							helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ko_KR"; output = "도움말 보기 및 종료";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pt_BR"; output = "apresenta esta mensagem de ajuda e encerramento";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ru_RU"; output = "показать это сообщение и выйти";						helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_CN"; output = "显示此帮助信息并退出";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_TW"; output = "顯示此協助訊息並退出";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "as_IN"; output = "এই সহায় বাৰ্তা দেখুৱাওক";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "bn_IN"; output = "এই বার্তা প্রদর্শন করে";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "hi_IN"; output = "इस मदद संदेश को दिखाएँ";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "mr_IN"; output = "हे मदत संदेश दाखवा व";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "gu_IN"; output = "આ મદદ સંદેશાને બતાવો અને";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "kn_IN"; output = "ಈ ನೆರವಿನ ಸಂದೇಶವನ್ನು";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ml_IN"; output = "ഈ സഹായ സന്ദേശം";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "or_IN"; output = "ଏହି ସହାୟତା ସନ୍ଦେଶ";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pa_IN"; output = "ਇਹ ਮੱਦਦ ਸੁਨੇਹਾ ਵਿਖਾਓ ਅਤੇ";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ta_IN"; output = "இந்த உதவி செய்தியை";									helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "te_IN"; output = "ఈ సహయ సందేశం చూపి";										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, helpOption.equals("--help")?0:1, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
