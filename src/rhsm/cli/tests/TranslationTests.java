...
// debugTesting pofilterTests = Arrays.asList("newlines");
	...
	protected List<List<Object>> getTranslatedCommandLineHelpDataAsListOfLists() {
		...
		lang = "ja_JP"; output = "使用法: subscription-manager register [オプション]";						if (Float.valueOf(clienttasks.redhatReleaseXY)>=7.6f) output = "使用方法: subscription-manager register [オプション]";
																										helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+" "+helpOption+" "+module, 0, newList(output.replaceAll("\\[(.+)\\]", /*"\\\\[($1|OPTIONS)\\\\]"*/"\\\\[$1\\\\]")+"$")}));
		...
		command = "rhsmcertd";
		lang = "en_US"; output = "Usage:\\n  rhsmcertd [OPTION...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "en_US"; output = "Usage:\\n  rhsmcertd [OPTION...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "de_DE"; output = "Aufruf:\\n  rhsmcertd [OPTION ...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "es_ES"; output = "Uso:\\n  rhsmcertd [OPCIÓN...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "fr_FR"; output = "Utilisation :\\n  rhsmcertd [OPTION...]";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {clienttasks.redhatReleaseX.equals("5")? new BlockedByBzBug("969608"):null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "it_IT"; output = "Uso:\\n  rhsmcertd [OPZIONE...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "ja_JP"; output = "用法:\\n  rhsmcertd [オプション...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "ko_KR"; output = "사용법:\\n  rhsmcertd [옵션...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "pt_BR"; output = "Uso:\\n  rhsmcertd [(OPÇÃO|OPÇÕES)...]";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "ru_RU"; output = "Использование:\\n  rhsmcertd [ПАРАМЕТР...]";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "zh_CN"; output = "用法：\\n  rhsmcertd [选项...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "zh_TW"; output = "用法：\\n  rhsmcertd [選項...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "as_IN"; output = "(ব্যৱহাৰ:|ব্যৱহাৰপ্ৰণালী:)\\n  rhsmcertd [OPTION...]";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {clienttasks.redhatReleaseX.equals("5")? new BlockedByBzBug("969608"):null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "bn_IN"; output = "ব্যবহারপ্রণালী:\\n  rhsmcertd [OPTION...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "hi_IN"; output = "प्रयोग:\\n  rhsmcertd [विकल्प...]";						helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "mr_IN"; output = "वापर:\\n  rhsmcertd [OPTION...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {clienttasks.redhatReleaseX.equals("5")? new BlockedByBzBug("969608"):null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "gu_IN"; output = "વપરાશ:\\n  rhsmcertd [OPTION...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "kn_IN"; output = "ಬಳಕೆ:\\n  rhsmcertd [OPTION...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {clienttasks.redhatReleaseX.equals("5")? new BlockedByBzBug("969608"):null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "ml_IN"; output = "ഉപയോഗിക്കേണ്ട വിധം:\\n  rhsmcertd [OPTION...]";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "or_IN"; output = "ବ୍ଯବହାର:\\n  rhsmcertd [ପସନ୍ଦ...]";					helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "pa_IN"; output = "ਵਰਤੋਂ:\\n  rhsmcertd [ਚੋਣ...]";						helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "ta_IN"; output = "பயன்பாடு:\\n  rhsmcertd [OPTION...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
		lang = "te_IN"; output = "వినిమయం:\\n  rhsmcertd [ఇచ్చాపూర్వరకం...]";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {null, lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION...)\\\\]").replaceAll("\\.\\.\\.","(\\\\.\\\\.\\\\.|…)")+"\\s*$")}));
