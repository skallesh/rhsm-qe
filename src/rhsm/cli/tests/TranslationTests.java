...
// debugTesting pofilterTests = Arrays.asList("newlines");
	...
	protected List<List<Object>> getTranslatedCommandLineHelpDataAsListOfLists() {
		...
		module = "clean";
		lang = "en_US"; output = "O|options:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "de_DE"; output = "O|optionen:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "es_ES"; output = "O|opciones:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "fr_FR"; output = "O|options:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "it_IT"; output = "O|opzioni:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ja_JP"; output = "オプション:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ko_KR"; output = "옵션:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pt_BR"; output = "O|opções:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ru_RU"; output = "П|параметры:";helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_CN"; output = "选项:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_TW"; output = "選項:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "as_IN"; output = "বিকল্পসমূহ:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "bn_IN"; output = "বিকল্প:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "hi_IN"; output = "विकल्प:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "mr_IN"; output = "पर्याय:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "gu_IN"; output = "વિકલ્પો:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "kn_IN"; output = "ಆಯ್ಕೆಗಳು:";		helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ml_IN"; output = "ഐച്ഛികങ്ങള്‍:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "or_IN"; output = "ବିକଳ୍ପଗୁଡିକ:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pa_IN"; output = "ਚੋਣਾਂ:";			helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ta_IN"; output = "விருப்பங்கள்:";	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "te_IN"; output = "ఐచ్చికాలు:";/*The options are:"ఐచ్చికములు:";*/	helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+module+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		lang = "de_DE"; output = "Zeige diese Hilfenachricht und beende";				helpOption=helpOptions.get(randomGenerator.nextInt(helpOptions.size())); ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"1074568"}), lang, command+" "+helpOption, 0, newList(output.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
	...
	protected List<List<Object>> getInvalidRegistrationWithLocalizedStringsAsListOfLists(){
		...
		if (!sm_usernameWithUnacceptedTC.equals("")) {
			if (sm_serverType.equals(CandlepinType.hosted))	ll.add(Arrays.asList(new Object[]{new BlockedByBzBug(new String[]{"615362","642805","1089034"}),"de_DE.UTF-8", sm_usernameWithUnacceptedTC, sm_passwordWithUnacceptedTC, 255, null, "Mensch, warum hast du auch etwas zu tun?? Bitte besuchen https://www.redhat.com/wapps/ugc!!!!!!!!!!!!!!!!!!"}));
		}
