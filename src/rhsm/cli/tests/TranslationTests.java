...
// debugTesting pofilterTests = Arrays.asList("newlines");
	...
	protected List<List<Object>> getTranslatedCommandLineHelpDataAsListOfLists() {
		...
		lang = "de_DE"; usage = "Verwendung: subscription-manager MODUL-NAME [MODUL-OPTIONEN] [--help]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "es_ES"; usage = "Uso: subscription-manager MÓDULO-NOMBRE [MÓDULO-OPCIONES] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "fr_FR"; usage = "Utilisation.*: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";		ll.add(Arrays.asList(new Object[] {null/*new BlockedByBzBug(new String[]{"707080","743734","743732"})*/, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "it_IT"; usage = "Utilizzo: subscription-manager NOME-MODULO [OPZIONI-MODULO] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ja_JP"; usage = "使い方: subscription-manager モジュール名 [モジュールオプション] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ko_KR"; usage = "사용법: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pt_BR"; usage = "Uso: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ru_RU"; usage = "Формат: subscription-manager ДЕЙСТВИЕ [ПАРАМЕТРЫ] [--help]";						ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_CN"; usage = "使用: subscription-manager 模块名称 [模块选项] [--help]";								ll.add(Arrays.asList(new Object[] {null/*new BlockedByBzBug(new String[]{"707080","743732"})*/, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "zh_TW"; usage = "使用方法：subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "as_IN"; usage = "ব্যৱহাৰ: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null/*new BlockedByBzBug(new String[]{"743732","750807"})*/, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "bn_IN"; usage = "ব্যবহারপ্রণালী: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "hi_IN"; usage = "प्रयोग: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "mr_IN"; usage = "वापर: subscription-manager मॉड्युल-नाव [मॉड्युल-पर्याय] [--help]";								ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "gu_IN"; usage = "વપરાશ: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "kn_IN"; usage = "ಬಳಕೆ: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug("811294"), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ml_IN"; usage = "ഉപയോഗിയ്ക്കേണ്ട വിധം: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "or_IN"; usage = "ବ୍ୟବହାର ବିଧି: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "pa_IN"; usage = "ਵਰਤੋਂ: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "ta_IN"; usage = "பயன்பாடு: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug("811301"), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		lang = "te_IN"; usage = "వాడుక: subscription-manager MODULE-NAME [MODULE-OPTIONS] [--help]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[", "\\\\[").replaceAll("\\]", "\\\\]")+"$")}));
		...
		module = "register";
		lang = "en_US"; usage = "Usage: subscription-manager register [OPTIONS]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "de_DE"; usage = "Verwendung: subscription-manager register [OPTIONEN]";			ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"693527","839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "es_ES"; usage = "Uso: subscription-manager register [OPCIONES]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "fr_FR"; usage = "Utilisation.*subscription-manager register [OPTIONS]";			ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "it_IT"; usage = "Utilizzo: subscription-manager register [OPZIONI]";			ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ja_JP"; usage = "使用法: subscription-manager register [オプション]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ko_KR"; usage = "사용법: subscription-manager register [옵션]";						ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "pt_BR"; usage = "Uso: subscription-manager register [OPÇÕES]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ru_RU"; usage = "Формат: subscription-manager register [ПАРАМЕТРЫ]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "zh_CN"; usage = "使用：subscription-manager register [选项]";						ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "zh_TW"; usage = "使用方法：subscription-manager register [OPTIONS]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "as_IN"; usage = "ব্যৱহাৰ: subscription-manager register [বিকল্পসমূহ]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"743732","839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "bn_IN"; usage = "ব্যবহারপ্রণালী: subscription-manager register [OPTIONS]";			ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "hi_IN"; usage = "प्रयोग: subscription-manager register [OPTIONS]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "mr_IN"; usage = "वापर: subscription-manager register [पर्याय]";						ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "gu_IN"; usage = "વપરાશ: subscription-manager register [OPTIONS]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "kn_IN"; usage = "ಬಳಕೆ: subscription-manager register [ಆಯ್ಕೆಗಳು]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"811294","839807","845304","886901"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ml_IN"; usage = "ഉപയോഗിയ്ക്കേണ്ട വിധം: subscription-manager register [ഐച്ഛികങ്ങള്‍]";		ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "or_IN"; usage = "ଉପଯୋଗ: subscription-manager register [ବିକଳ୍ପଗୁଡ଼ିକ]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "pa_IN"; usage = "ਵਰਤੋਂ: subscription-manager register [ਚੋਣਾਂ]";						ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ta_IN"; usage = "பயன்பாடு: subscription-manager register [OPTIONS]";				ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "te_IN"; usage = "వా‍డుక: subscription-manager register [ఐచ్చికాలు]";					ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"839807","845304"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size()))+" "+module, newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		...
		lang = "en_US"; usage = "Usage: rhn-migrate-classic-to-rhsm [OPTIONS]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "de_DE"; usage = "Verwendung: rhn-migrate-classic-to-rhsm [OPTIONEN]";		ll.add(Arrays.asList(new Object[] {new BlockedByBzBug(new String[]{"707080"}), lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "es_ES"; usage = "Uso: rhn-migrate-classic-to-rhsm [OPCIONES]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "fr_FR"; usage = "Utilisation.*rhn-migrate-classic-to-rhsm [OPTIONS]";		ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "it_IT"; usage = "Utilizzo: rhn-migrate-classic-to-rhsm [OPZIONI]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ja_JP"; usage = "使用法: rhn-migrate-classic-to-rhsm [オプション]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ko_KR"; usage = "사용법: rhn-migrate-classic-to-rhsm [옵션]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "pt_BR"; usage = "Uso: rhn-migrate-classic-to-rhsm [OPÇÕES]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ru_RU"; usage = "Формат: rhn-migrate-classic-to-rhsm [ПАРАМЕТРЫ]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "zh_CN"; usage = "使用：rhn-migrate-classic-to-rhsm [选项]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "zh_TW"; usage = "使用方法：rhn-migrate-classic-to-rhsm [OPTIONS]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "as_IN"; usage = "ব্যৱহাৰ: rhn-migrate-classic-to-rhsm [বিকল্পসমূহ]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "bn_IN"; usage = "ব্যবহারপ্রণালী: rhn-migrate-classic-to-rhsm [OPTIONS]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "hi_IN"; usage = "प्रयोग: rhn-migrate-classic-to-rhsm [OPTIONS]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "mr_IN"; usage = "वापर: rhn-migrate-classic-to-rhsm [पर्याय]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "gu_IN"; usage = "વપરાશ: rhn-migrate-classic-to-rhsm [OPTIONS]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "kn_IN"; usage = "ಬಳಕೆ: rhn-migrate-classic-to-rhsm [ಆಯ್ಕೆಗಳು]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ml_IN"; usage = "ഉപയോഗിയ്ക്കേണ്ട വിധം: rhn-migrate-classic-to-rhsm [ഐച്ഛികങ്ങള്‍]";	ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "or_IN"; usage = "ଉପଯୋଗ: rhn-migrate-classic-to-rhsm [ବିକଳ୍ପଗୁଡ଼ିକ]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "pa_IN"; usage = "ਵਰਤੋਂ: rhn-migrate-classic-to-rhsm [ਚੋਣਾਂ]";						ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "ta_IN"; usage = "பயன்பாடு: rhn-migrate-classic-to-rhsm [OPTIONS]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));
		lang = "te_IN"; usage = "వా‍డుక: rhn-migrate-classic-to-rhsm [ఐచ్చికాలు]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\[(.+)\\]", "\\\\[($1|OPTIONS)\\\\]")+"$")}));

		
		// rhsmcertd (-h or --help option is randomly chosen for each lang)
		command = "rhsmcertd";
		lang = "en_US"; usage = "Usage:\\n  rhsmcertd [OPTION...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "de_DE"; usage = "Aufruf:\\n  rhsmcertd [OPTION …]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "es_ES"; usage = "Uso:\\n  rhsmcertd [OPCIÓN…]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "fr_FR"; usage = "Utilisation :\\n  rhsmcertd [OPTION...]";		ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "it_IT"; usage = "Uso:\\n  rhsmcertd [OPZIONE...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "ja_JP"; usage = "用法:\\n  rhsmcertd [オプション...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "ko_KR"; usage = "사용법:\\n  rhsmcertd [옵션...]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "pt_BR"; usage = "Uso:\\n  rhsmcertd [OPÇÕES...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "ru_RU"; usage = "Использование:\\n  rhsmcertd [ПАРАМЕТР...]";	ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "zh_CN"; usage = "用法：\\n  rhsmcertd [选项...]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "zh_TW"; usage = "用法：\\n  rhsmcertd [選項...]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "as_IN"; usage = "ব্যৱহাৰপ্ৰণালী:\\n  rhsmcertd [OPTION...]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "bn_IN"; usage = "ব্যবহারপ্রণালী:\\n  rhsmcertd [OPTION...]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "hi_IN"; usage = "प्रयोग:\\n  rhsmcertd [विकल्प...]";					ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "mr_IN"; usage = "वापर:\\n  rhsmcertd [OPTION...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "gu_IN"; usage = "વપરાશ:\\n  rhsmcertd [OPTION...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "kn_IN"; usage = "ಬಳಕೆ:\\n  rhsmcertd [OPTION...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "ml_IN"; usage = "ഉപയോഗിക്കേണ്ട വിധം:\\n  rhsmcertd [OPTION...]";		ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "or_IN"; usage = "ବ୍ଯବହାର:\\n  rhsmcertd [ପସନ୍ଦ...]";				ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "pa_IN"; usage = "ਵਰਤੋਂ:\\n  rhsmcertd [ਚੋਣ...]";						ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "ta_IN"; usage = "பயன்பாடு:\\n  rhsmcertd [OPTION...]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
		lang = "te_IN"; usage = "వినిమయం:\\n  rhsmcertd [ఇచ్చాపూర్వరకం...]";			ll.add(Arrays.asList(new Object[] {null, lang, command+helpOptions.get(randomGenerator.nextInt(helpOptions.size())), newList(usage.replaceAll("\\.","\\\\.").replaceAll("\\[(.+)\\]", "\\\\[($1|OPTION\\.\\.\\.)\\\\]")+"\\s*$")}));
