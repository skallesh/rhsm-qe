...
//	@ImplementsNitrateTest(caseId={41691, 47918})
	...
	public void testRegisterWithAutosubscribe_DEPRECATED() throws JSONException, Exception {
		...
		Assert.assertEquals(clienttasks.list_(null, null, null, Boolean.TRUE, null, null, null, null, null, null, null, null, null, null, null).getStdout().trim(),"No installed products to list",
		...
		*/
		...
		InstalledProduct autoSubscribedProduct = InstalledProduct.findFirstInstanceWithMatchingFieldFromList("status", "Subscribed", InstalledProduct.parse(clienttasks.list_(null, null, null, Boolean.TRUE, null, null, null, null, null, null, null, null, null, null, null).getStdout()));
