...
(declare entitlement-socket)

;; (defn ^{Test {:groups ["entitlement"
;;                        "REST"
;;                        "API"
;;                        "tier1"]
...
(defn entitlement-socket
  ...
  (-> (->> "busctl call com.redhat.RHSM1 /com/redhat/RHSM1/Entitlement com.redhat.RHSM1.Entitlement Start"
           run-command
           :stdout
           (re-seq #"abstract=([^,]+)"))
      (nth 0)
